...
options.register('outFilename', 'JetTaggingVariables_ttjetsMLM_76X.root',
...
## Input files
inputFiles = [
'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/kderoove/BTagAnalyzer_CSVv2/76X/Tree_TTJets_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_merged_0.root'
]
