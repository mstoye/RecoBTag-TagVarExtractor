...
Example: ./createAndSubmitJobs.py -i /cms/ferencek/store/ferencek/QCD_Pt-300to470_TuneZ2star_8TeV_pythia6/Summer12_DR53X-PU_S10_START53_V7A-v2_BTagAnalyzer_V02-05-03_v2/ -c tagvarextractor_cfg.py -o output_dir -n 60 -p maxEvents=-1,reportEvery=1000,wantSummary=True"""
